...
public class CelsiusConverterTest {
     ...
     * so an exception - of type 'IllegalArgumentException' should be thrown.
     */
    @Test
    public void throwsArgumentException() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {c.getMessage(c.convertCelsius(93.20));});
    }

    /**
     * 97.20 Fahrenheit Degrees is the minimum normal value for the human body temperature(36.20 Celsius degrees)
     * This method shouldn't return an IllegalArgumentException
     */
    @Test
    public void noArgumentException() {
        Assertions.assertDoesNotThrow(() -> {c.getMessage(c.convertCelsius(97.20));});
    }
}