...
class InputDataTest {
    ...
    /**
     * Testing if introduced hour coordinate is not valid
     * Hour must be between 0-23
     */
    @Test
    public void checkDateNotEqualsHours() {
        boolean condition = input.checkDate(24,20);
        Assertions.assertFalse(condition);
    }

    /**
     * Testing if introduced minutes coordinate is not valid
     * Hour must be between 0-59
     */
    @Test
    public void checkDateNotEqualsMins() {
        boolean condition = input.checkDate(5,60);
        Assertions.assertFalse(condition);
    }
